    ...
    <div className="w-[80%] mx-auto">
      ...
      <div>
        ...
        <p className="mb-4 font-medium">
          ...
          безопасности персональных данных, предпринимаемые Адвокатом
          Мордвинцевым Романом Фёдоровичем (далее — Оператор).
        </p>
        ...
        <p className="paragraph">
          ...
          сети интернет по сетевому адресу https://amordvintsev.ru/politics.
        </p>
        <p className="paragraph">
          ...
          <Table>
            ...
            <TableBody className="w-[40%]">
              ...
              <TableRow>
                ...
                <TableCell className="font-medium">
                  ФЗ № 152-ФЗ «О персональных данных» от 27.07.2006 г. Отправка
        ...
        <p className="paragraph">
          ...
          info@amordvintsev.ru с пометкой «Актуализация персональных данных».
        </p>
        <p className="paragraph">
          ...
          на электронный адрес Оператора info@amordvintsev.ru с пометкой «Отзыв
        ...
        <p className="paragraph">
          ...
          Оператору с помощью электронной почты info@amordvintsev.ru.
        </p>
        <p className="paragraph">
